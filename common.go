...
func errorWrapper(localFilePath string, summaryFilePath string, referenceFilePath string, outputFilePath string, f func(localFilePath string, summaryFilePath string, referenceFilePath string, outputFilePath string) error) int {
	defer func() int {
		if p := recover(); p != nil {
	...
	if err := f(localFilePath, summaryFilePath, referenceFilePath, outputFilePath); err != nil {
...
func diffErrorWrapper(localFilePath string, summaryFilePath string, referenceFilePath string, outputFilePath string, f func(localFilePath string, summaryFilePath string, referenceFilePath string, outputFilePath string) (string,error)) (string, error) {
	defer func() {
		if p := recover(); p != nil {
			fmt.Fprintln(os.Stderr, p)
			//os.Exit(1)
	...
	jsonDiff,err := f(localFilePath, summaryFilePath, referenceFilePath, outputFilePath)
